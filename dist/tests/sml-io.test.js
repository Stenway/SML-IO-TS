...
test("SyncBinarySmlStreamReader", () => {
    ...
    const node1 = reader.readNode();
    expect(node1 === null || node1 === void 0 ? void 0 : node1.isAttribute()).toEqual(true);
    expect(node1.toString()).toEqual(`A 1 "" -`);
    const node2 = reader.readNode();
    expect(node2 === null || node2 === void 0 ? void 0 : node2.isElement()).toEqual(true);
    expect(node2.toString()).toEqual(`E\nEnd`);
    const node3 = reader.readNode();
    expect(node3 === null || node3 === void 0 ? void 0 : node3.isElement()).toEqual(true);
    expect(node3.toString()).toEqual(`E\n\t"" 2\n\t""\n\tEnd\nEnd`);
...
describe("SyncBinarySmlStreamReader", () => {
    ...
    test.each([
        ...
        expect(node.values).toEqual([longValue1, longValue2, "c", "d"]);
        reader.close();
    });
});
// ----------------------------------------------------------------------
